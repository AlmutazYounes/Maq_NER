"""
Submission script for MutazYoune/bert-base-arabic-camelbert-mix-ner-patterns_small
This model uses pattern replacement with small patterns set.
"""

from submission_helper import get_ner_pipeline, mask_pii

# Model configuration
MODEL_NAME = "MutazYoune/bert-base-arabic-camelbert-mix-ner-patterns_small"
