"""
Submission script for MutazYoune/Arabic-NER-PII + Small Patterns
This model runs NER first, then applies small pattern checking to catch missed PII.
"""

from submission_helper import get_ner_pipeline, mask_pii, patterns_small, apply_patterns_to_text
import re
...
def run(sentence):
    ...
    Uses NER first, then applies small pattern checking to catch any missed PII.
    """
    ...
    for pattern_name, pattern_info in patterns_small.items():
        try:
